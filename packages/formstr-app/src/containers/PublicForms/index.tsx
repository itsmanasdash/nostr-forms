import { Button, Card, Divider, Typography, Skeleton } from 'antd';
        ...
        forms.map((f: Event) => {
          if (f.content === '') {
            ...
            const truncatedDescription =
              description.trim().substring(0, 200) + (description.length > 200 ? '...' : '');
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <Typography.Text style={{ color: 'grey', fontSize: 12, margin: 10 }}>
                    {}
