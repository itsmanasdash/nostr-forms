...
function DeleteConfirmationLocal({ formKey, onCancel, onDeleted }: IDeleteFormsLocal) {
  const onDeleteForm = () => {
  ...
  return (
    <>
      ...
      {deleteConfirmationOpen && (
        <DeleteConfirmationLocal formKey={formKey} onDeleted={onDelete} onCancel={onCancel} />
      )}
    </>
  );
}
